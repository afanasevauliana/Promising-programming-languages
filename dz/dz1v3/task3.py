...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QLabel, QRadioButton, QButtonGroup, QFrame, QMessageBox)
...
class Example(QMainWindow):
    ...
    def show_info_message(self):
        QMessageBox.information(self, 'Справка', 'Обращение за справкой')
